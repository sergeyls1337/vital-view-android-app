...
const translations = {
  en: {
    ...
    weight: {
      ...
      insightsTitle: "Weight Insights",
      needMoreData: "Need more data to show insights",
    },
    steps: {
    ...
    tips: {
      ...
      steps: {
        ...
        early: "Great start! Every step counts towards your goal",
        quarter: "You're making good progress! Keep moving",
      ...
      sleep: {
        track: "Start tracking your sleep to improve your rest quality",
        short: "Try to get at least 7-8 hours of sleep tonight",
        low: "Aim for 7-8 hours of sleep for optimal health",
        good: "Great sleep! Try to maintain this schedule",
        optimal: "Perfect sleep duration! Keep up the excellent routine",
      ...
      weight: {
        ...
        goalFar: "Focus on healthy habits, you're {amount}kg from your goal",
        achieved: "Congratulations! You've reached your target weight",
        maintain: "Great job maintaining your target weight!",
      },
      general: {
        morning: "Start your day with energy and purpose!",
        afternoon: "Keep up the momentum throughout the day",
        evening: "Wind down and prepare for a restful night",
        energy: "Fuel your body with nutritious foods and stay active",
        ...
        reflect: "Take time to reflect on your progress today",
        weekStart: "New week, new opportunities for healthy choices",
        weekEnd: "Finish the week strong with your health goals",
        weekend: "Use the weekend to recharge and stay active",
        celebrate: "Celebrate small wins on your health journey",
        consistency: "Consistency is key - track your metrics daily",
        motivation: "Every healthy choice you make matters",
        start: "Take the first step towards your health goals today",
      },
    },
  },
  uk: {
    ...
    weight: {
      ...
      insightsTitle: "Аналітика ваги",
      needMoreData: "Потрібно більше даних для показу аналітики",
    },
    steps: {
    ...
    tips: {
      ...
      steps: {
        ...
        early: "Чудовий початок! Кожен крок рахується до вашої цілі",
        quarter: "Ви робите гарний прогрес! Продовжуйте рухатися",
      ...
      sleep: {
        track: "Почніть відстежувати свій сон для покращення якості відпочинку",
        short: "Спробуйте спати принаймні 7-8 годин сьогодні вночі",
        low: "Прагніть до 7-8 годин сну для оптимального здоров'я",
        good: "Чудовий сон! Спробуйте підтримувати цей розпорядок",
        optimal: "Ідеальна тривалість сну! Продовжуйте цю відмінну рутину",
      ...
      weight: {
        ...
        goalFar: "Зосередьтеся на здорових звичках, вам залишилося {amount}кг до цілі",
        achieved: "Вітаємо! Ви досягли цільової ваги",
        maintain: "Чудова робота з підтримкою цільової ваги!",
      },
      general: {
        morning: "Почніть свій день з енергією та цілеспрямованістю!",
        afternoon: "Підтримуйте темп протягом дня",
        evening: "Заспокойтеся та підготуйтеся до спокійної ночі",
        energy: "Живіть своє тіло поживною їжею та залишайтеся активними",
        ...
        reflect: "Приділіть час для роздумів про свій прогрес сьогодні",
        weekStart: "Новий тиждень, нові можливості для здорових виборів",
        weekEnd: "Завершіть тиждень сильно зі своїми цілями здоров'я",
        weekend: "Використовуйте вихідні для відновлення та активності",
        ...
        motivation: "Кожен здоровий вибір, який ви робите, має значення",
        start: "Зробіть перший крок до своїх цілей здоров'я сьогодні",
      },
    },
  },
};
