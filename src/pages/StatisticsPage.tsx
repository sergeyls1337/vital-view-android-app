...
const StatisticsPage = () => {
  ...
  const activityDistribution = [
    { name: 'Walking', value: 40, color: '#3b82f6' },
    { name: 'Running', value: 25, color: '#10b981' },
    { name: 'Cycling', value: 20, color: '#f59e0b' },
    { name: 'Swimming', value: 15, color: '#8b5cf6' }
  ];
    ...
    <div className="pb-20 px-6 max-w-4xl mx-auto">
      ...
      <Tabs defaultValue="activity" className="space-y-4">
        ...
        <TabsContent value="activity" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Steps and calories burned this week</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-72">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your favorite activities</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-72">
                <ResponsiveContainer width="100%" height="100%">
        ...
        <TabsContent value="water" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Water Intake Trends</CardTitle>
        ...
        <TabsContent value="sleep" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sleep duration and quality over time</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-72">
                <ResponsiveContainer width="100%" height="100%">
